export const BOT_PATTERNS = {
  ...
  yahoo: [/Slurp/i, /yahoo/i],
  yandex: [/YandexBot/i, /YandexImages/i, /YandexVideo/i, /YandexMedia/i, /YandexBlogs/i],
  baidu: [/Baiduspider/i, /Baiduspider-image/i, /Baiduspider-video/i],
  duckduckgo: [/DuckDuckBot/i, /DuckDuckGo-Favicons-Bot/i],
  facebook: [/facebookexternalhit/i, /FacebookBot/i],
  twitter: [/Twitterbot/i],
  linkedin: [/LinkedInBot/i],
  pinterest: [/Pinterest/i],
  apple: [/Applebot/i],
  messaging: [/slackbot/i, /discordbot/i, /whatsapp/i, /skypeuripreview/i, /telegrambot/i],
  other: [/crawler/i, /spider/i, /bot\//i, /slurp/i],
}
